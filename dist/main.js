...
class App extends react_1.default.Component {
    componentDidMount() {
        return __awaiter(this, void 0, void 0, function* () {
            const weather = yield fetch('http://samples.openweathermap.org/data/2.5/weather?q=London&appid=9d7c3c613f7362eca3f5c988f71e9d87', {
                method: 'GET',
                headers: {
    ...
    render() {
        return (react_1.default.createElement("div", null,
            react_1.default.createElement(Loadingbar_1.default, null),
            react_1.default.createElement(WeatherCard_1.default, null)));
    }
}
exports.default = App;
...
class Loadingbar extends react_1.default.Component {
    ...
    render() {
        return (react_1.default.createElement("div", { className: 'weather-card ' + (this.state.opened ? 'opened' : '') },
            react_1.default.createElement("div", { className: "weather-card-leftside", onClick: this.toggleCard },
                react_1.default.createElement("div", { className: "container" },
                    react_1.default.createElement("div", { className: "date" }, moment_1.default().format('DD MMMM YYYY')),
                    react_1.default.createElement("div", { className: "locale" }, "Budapest")),
                react_1.default.createElement("div", { className: "container" },
                    react_1.default.createElement("div", { className: "temp" }, "28"),
                    react_1.default.createElement("div", { className: "unit" }, "Celsius"))),
